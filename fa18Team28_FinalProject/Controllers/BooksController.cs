...
namespace fa18Team28_FinalProject.Controllers
{
    public class BooksController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookID,PublishedDate,UniqueID,Title,Author,Description,Price,Cost,Reordered,PurchaseCount,CopiesOnHand,LastOrdered")] Book book)
        {
            if (id != book.BookID)
            {
                return NotFound();
